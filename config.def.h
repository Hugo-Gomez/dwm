...
static const char norm_fg[]         = "#b0caec";
static const char norm_bg[]         = "#222d32";
static const char sel_fg[]          = "#eec58b";
static const char sel_bg[]          = "#2a353d";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	/* [SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { col_gray4, col_cyan,  col_cyan  },*/
	[SchemeNorm] = { norm_fg, norm_bg, norm_bg },
	[SchemeSel]  = { sel_fg, sel_bg, sel_fg }, /*#6D92A0*/
};
...
static Key keys[] = {
	...
	/* Change keys for French azerty layout */
	TAGKEYS(                        0x26,                      0)
	TAGKEYS(                        0xe9,                      1)
	TAGKEYS(                        0x22,                      2)
	TAGKEYS(                        0x27,                      3)
